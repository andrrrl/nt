...
class YTPlayer {
    constructor() {
        this.argv = [];
        this.videoList = [];
        this.appTitle = '▶ Lantube CLI';
        this.horizontalDiv = '─';
        this.verticalDiv = '│';
        this.emptyDiv = ' ';
        this.YOUTUBE_URL = 'https://www.youtube.com';
        this.SERVER_URL = 'http://localhost:3000';
        this.ADD_VIDEO = '/api/videos/add/:video';
        this.PLAY_VIDEO = '/api/player/:id/play';
    }
    init(argv) {
        this.argv = argv;
...
//# sourceMappingURL=ytplayer.class.js.map